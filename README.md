  ...
  <body>
      ...
      <div class="wrapper">
        ...
        <div class="menu">
          ...
          <ul class="social-links">
            <li>
              <a target="_blank" href="https://instagram.com/jonspada"
                ><svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            <li>
              <a target="_blank" href="https://facebook.com/jonspada">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
            ...
            <li>
              <a target="_blank" href="https://youtube.com/jonspada">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
    ...
    <section id="contact">
      <div class="wrapper">
        ...
        <div class="col-b">
          <img
            src="./assets/homem-negro-com-moletom-bege-mexendo-no-celular.png"
    ...
    <footer>
      <div class="wrapper">
        ...
        <div class="col-b">
          <ul class="social-links">
            <li>
              <a target="_blank" href="https://instagram.com/jon.spada"
                ><svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
